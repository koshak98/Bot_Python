...
def start(message):
    bot.send_message(message.from_user.id, "Hi! I'm a SportBot. I will help you to find information about your favorite football clubs.");
